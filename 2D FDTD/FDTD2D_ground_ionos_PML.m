...
% assuming reflections between ground and inosphere waveguide and PML
...
for N = 1:nmax
    ...
    for k = 2:kmax-1     % update Ez for source at first i=1,k=1 point using ampere' law in integral form
